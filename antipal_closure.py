...
def set_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="generate word using antipalindromic closure of the given sequence")
...
def main():
    ...
    rule = [x for x in range(10)]
    print(*rule, end=" ")
    print(*rule, end=" ")
    print(*rule)
    done = pc.antipal_closure(dir, period, iters, dev)
